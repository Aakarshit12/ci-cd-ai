...
JWT_SECRET = os.getenv("JWT_SECRET", os.getenv("SECRET_KEY", "CHANGE_THIS_TO_A_LONG_RANDOM_STr"))
...
def validate_token(request: Request) -> Tuple[bool, Optional[str], Optional[str]]:
    ...
    try:
        ...
        # Alternatively, if they are packing the api_key in the token string itself intentionally
